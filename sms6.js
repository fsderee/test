документ . getElementById ( ' текст ' ). focus ();

setTimeout ( function () {
var result =  $ ( " #text " ). val ();
// var t = "Морки";
// $ ('[data-position * = "' + t + '"]'). click ();
var arr =  результат . split ( ' , ' );
var nameer = arr [ 1 ];
...
$ ( " li [data-tab = 'tab-7'] " ). click ();
  документ . getElementById ( " phone465 " ). click ();
  var result =  $ ( " #text " ). val ();
...
$ ( " li [data-tab = 'tab-31'] " ). click ();
    документ . getElementById ( " phone1985 " ). click ();
  var result =  $ ( " #text " ). val ();
...
$ ( " li [data-tab = 'tab-39'] " ). click ();
  документ . getElementById ( " phone2409 " ). click ();
  var result =  $ ( " #text " ). val ();
var t = arr [ 2 ]. trim ();
$ ( ' [data-keyword * = " ' + t + ' "] ' ). click ();
...
документ . getElementById ( " phone2413 " ). click ();
    документ . getElementById ( " phone2402 " ). click ();
    документ . getElementById ( " phone2403 " ). click ();
}
       
  }
   if ( nameer . indexOf ( ' Оренбургская ' ) > = 0 ) {
$ ( " li [data-tab = 'tab-42'] " ). click ();
  документ . getElementById ( " phone2584 " ). click ();
  var result =  $ ( " #text " ). val ();
var t = arr [ 2 ]. trim ();
$ ( ' [data-keyword * = " ' + t + ' "] ' ). click ();
   }
