...
document.getElementById("group_def_tab-history_form-new_comment").value ='Дано смс ответственному подрезденению' ;
...
var mess = "Недоступно оборудование " + adres +' '+ y + ' ' + namberGP ;
